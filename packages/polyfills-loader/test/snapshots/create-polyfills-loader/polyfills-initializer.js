...
(function() {
  ...
  if ('noModule' in HTMLScriptElement.prototype && (function () { try { Function('window.importShim = s => import(s);').call(); return true; } catch (_) { return false } })()) { polyfills.push(loadScript('./polyfills/dynamic-import.js').then(function () { window.dynamicImportPolyfill.initialize({ importFunctionName: 'importShim' }); })) }
